...
export const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-8 pt-32 text-center">
      ...
      >
        <Link href="https://github.com/gregm711/greg-app-template">
      ...
      >
        ...
        >
          Use Greg's app template to save time and get started with your next
          project.
        </motion.div>
        ...
        >
          <Link
            href="https://github.com/gregm711/greg-app-template"
